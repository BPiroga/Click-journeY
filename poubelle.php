...
<input type="number" name="prix_max" id="prix_max" placeholder="Prix max (€)" min="0" value="<?= htmlspecialchars($prixMax) ?>">
<input type="number" name="duree_min" id="duree_min" placeholder="Durée min (jours)" min="0" value="<?= htmlspecialchars($dureeMin) ?>">
...
<body>
    ...
    <div class="container-recherche">
        <form class="filters" method="get" action="recherche.php">
            ...
            <button type="submit">Rechercher</button> <!-- <button id="btn-rechercher">Rechercher</button> -->
        </form>
